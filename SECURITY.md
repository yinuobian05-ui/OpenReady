...
`0.1.x` is the current supported line, beginning with the public GitHub release `v0.1.0`. The package has not been published to npm. Security fixes will be documented in the changelog and release notes.
